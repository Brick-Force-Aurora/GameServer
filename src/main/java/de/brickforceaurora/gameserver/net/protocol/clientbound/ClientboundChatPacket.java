...
public final class ClientboundChatPacket implements IClientboundPacket {
    ...
    public ClientboundChatPacket val(final int val) {
        this.val = val;
        return this;
    }
    ...
    public ClientboundChatPacket val2(final int val2) {
    ...
    public ClientboundChatPacket val3(final String val3) {
        this.val3 = val3;
        return this;
    }
    ...
    public ClientboundChatPacket val4(final String val4) {
        this.val4 = val4;
        return this;
    }
    ...
    public ClientboundChatPacket val5(final boolean val5) {
        this.val5 = val5;
        return this;
    }
