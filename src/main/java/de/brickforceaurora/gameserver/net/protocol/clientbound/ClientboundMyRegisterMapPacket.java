...
public final class ClientboundMyRegisterMapPacket implements IClientboundPacket {
	...
	public final ClientboundMyRegisterMapPacket count(int count) {
		this.count = count;
		return this;
	}
	...
	public final ClientboundMyRegisterMapPacket offset(int offset) {
		this.offset = offset;
		return this;
	}
	...
	public final ClientboundMyRegisterMapPacket regMaps(RegMap[] regMaps) {
