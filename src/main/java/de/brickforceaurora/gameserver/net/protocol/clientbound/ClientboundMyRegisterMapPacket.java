...
public final class ClientboundMyRegisterMapPacket implements IClientboundPacket {
    ...
    public ClientboundMyRegisterMapPacket page(final int page) {
        this.page = page;
        return this;
    }
    ...
    public ClientboundMyRegisterMapPacket count(final int count) {
        this.count = count;
        return this;
    }
    ...
    public ClientboundMyRegisterMapPacket offset(final int offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ClientboundMyRegisterMapPacket regMaps(final RegMap[] regMaps) {
