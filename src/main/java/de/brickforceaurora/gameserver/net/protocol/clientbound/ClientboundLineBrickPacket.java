...
public final class ClientboundLineBrickPacket implements IClientboundPacket {
    ...
    public ClientboundLineBrickPacket val(final int val) {
        this.val = val;
        return this;
    }
    ...
    public ClientboundLineBrickPacket val2(final int val2) {
        this.val2 = val2;
        return this;
    }
    ...
    public ClientboundLineBrickPacket val3(final int val3) {
    ...
    public ClientboundLineBrickPacket val4(final int val4) {
    ...
    public ClientboundLineBrickPacket val5(final int val5) {
    ...
    public ClientboundLineBrickPacket val6(final int val6) {
    ...
    public ClientboundLineBrickPacket val7(final int val7) {
