...
public final class ClientboundAddBrickPacket implements IClientboundPacket {
	...
	public final ClientboundAddBrickPacket val(int val) {
		this.val = val;
		return this;
	}
	...
	public final ClientboundAddBrickPacket val2(int val2) {
		this.val2 = val2;
		return this;
	}
	...
	public final ClientboundAddBrickPacket val3(int val3) {
	...
	public final ClientboundAddBrickPacket val4(int val4) {
	...
	public final ClientboundAddBrickPacket val5(int val5) {
	...
	public final ClientboundAddBrickPacket val6(int val6) {
	...
	public final ClientboundAddBrickPacket val7(int val7) {
