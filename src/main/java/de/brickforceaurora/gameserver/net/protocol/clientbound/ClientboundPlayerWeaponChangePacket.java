...
public final class ClientboundPlayerWeaponChangePacket implements IClientboundPacket {
    ...
    public ClientboundPlayerWeaponChangePacket val(final int val) {
        this.val = val;
        return this;
    }
    ...
    public ClientboundPlayerWeaponChangePacket val2(final String val2) {
        this.val2 = val2;
        return this;
    }
    ...
    public ClientboundPlayerWeaponChangePacket val3(final String val3) {
        this.val3 = val3;
        return this;
    }
