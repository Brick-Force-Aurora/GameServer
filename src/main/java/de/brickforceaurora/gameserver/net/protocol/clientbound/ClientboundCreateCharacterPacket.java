...
public final class ClientboundCreateCharacterPacket implements IClientboundPacket {
    ...
    public ClientboundCreateCharacterPacket val(final int val) {
        this.val = val;
        return this;
    }
    ...
    public ClientboundCreateCharacterPacket val2(final String val2) {
        this.val2 = val2;
        return this;
    }
    ...
    public ClientboundCreateCharacterPacket val3(final String val3) {
        this.val3 = val3;
        return this;
    }
