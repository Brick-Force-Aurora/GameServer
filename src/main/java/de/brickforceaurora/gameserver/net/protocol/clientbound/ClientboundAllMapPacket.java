...
public final class ClientboundAllMapPacket implements IClientboundPacket {
    ...
    public ClientboundAllMapPacket page(final int page) {
        this.page = page;
        return this;
    }
    ...
    public ClientboundAllMapPacket regMaps(final RegMap[] regMaps) {
    ...
    public void write(final ByteBuf buffer) {
        ...
        buffer.writeIntLE(this.regMaps.length);
        for (final RegMap regMap : this.regMaps) {
