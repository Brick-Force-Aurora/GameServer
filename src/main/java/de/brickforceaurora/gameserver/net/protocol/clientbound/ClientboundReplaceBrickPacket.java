...
public final class ClientboundReplaceBrickPacket implements IClientboundPacket {
    ...
    public ClientboundReplaceBrickPacket val(final int val) {
        this.val = val;
        return this;
    }
    ...
    public ClientboundReplaceBrickPacket val2(final int val2) {
        this.val2 = val2;
        return this;
    }
    ...
    public ClientboundReplaceBrickPacket val3(final int val3) {
        this.val3 = val3;
        return this;
    }
    ...
    public ClientboundReplaceBrickPacket val4(final int val4) {
    ...
    public ClientboundReplaceBrickPacket val5(final int val5) {
    ...
    public ClientboundReplaceBrickPacket val6(final int val6) {
    ...
    public ClientboundReplaceBrickPacket val7(final int val7) {
    ...
    public ClientboundReplaceBrickPacket val8(final int val8) {
