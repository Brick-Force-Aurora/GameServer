...
public class ChannelManager {
    ...
    public Channel newChannel(ChannelMode mode, String name) {
        Channel channel = mode2channel.get(mode).newChannel(name);
    ...
    public ObjectList<Channel> channels(ChannelMode mode) {
        ChannelHolder holder = mode2channel.get(mode);
        ObjectArrayList<Channel> channels = new ObjectArrayList<>(holder.channelCount());
