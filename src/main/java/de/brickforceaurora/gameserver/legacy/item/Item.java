...
import de.brickforceaurora.gameserver.legacy.data.MyInfoManager;
import de.brickforceaurora.gameserver.legacy.item.template.TItem;
import de.brickforceaurora.gameserver.legacy.item.template.TSpecial;
import de.brickforceaurora.gameserver.legacy.util.StringMgr;
